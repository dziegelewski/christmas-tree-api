...
export function generateProducts(numberOfProducts: number): TreeModel[] {
  return times(30, generateSingleProduct);
}

function generateSingleProduct(id: number): TreeModel {
  console.log(`Generating ${id} products`)
  return {
    id,
...
function randomImage() {
  ...
  return (`../images/tree${imageNumber}.png`);
}
